        ...
        <div className="space-y-6 md:space-y-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {products?.map((product) => (
              <div
                key={product?.id}
                className="bg-white border border-gray-300 rounded-2xl p-2 md:p-3 hover:shadow-lg transition-shadow cursor-pointer"
              ...
              >
                ...
                <div className="relative mb-3 md:mb-4">
                  ...
                  <div className="absolute top-3 left-3 right-3 flex justify-between items-start">
                    {product?.badge && (
                      <span
                        className={`${product?.badgeColor} text-white text-sm font-medium px-2 py-1 rounded-2xl`}
                      >
                        {product?.badge}
                      </span>
                    )}
                    ...
                    <button
                      className="bg-white hover:bg-gray-100 rounded-2xl p-1.5 shadow-md transition-colors ml-auto"
